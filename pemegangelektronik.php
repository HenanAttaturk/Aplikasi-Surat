...
if (isset($_POST["kirim"])) {
  ...
  if (tambahElektronik($_POST) > 0) {
    echo "
              <script> alert('Surat Berhasil Terbuat!');
                      document.location.href = 'penunjukkanelektronikpdf.php';
              </script>
              ";
  } else {
    echo "
      <script> alert('Mohon Maaf! Surat Gagal diBuat!');
              document.location.href = 'pemegangelektronik.php';
      </script>
      ";
  }
}
...
<body>
  ...
  <div class="jumbotron text-center">
    ...
    <h3>&#8608; Surat Penunjukkan Elektronik &#8606;</h3>
  </div>
  <!-- End Jumbotron -->
  ...
  <section class="form" id="form">
    <div class="container">
      <h4 class="text-center fw-bold">Masukkan Input Data Surat Penunjukkan Pemegang Elektronik</h4>
      <hr>
      <div class="row mt-2">
    ...
    <div class="container">
      <div class="row mt-2">
        ...
        <div class="col-md-6">
          ...
          <div class="form-group">
            <label for="nomesin">Nomor Mesin/ Nomor Seri :</label>
