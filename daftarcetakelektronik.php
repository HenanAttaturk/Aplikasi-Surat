...
<body>
  ...
  <div class="jumbotron text-center">
    ...
    <h2>Daftar Cetak Surat Penunjukkan Elektronik</h2>
  </div>
  <!-- End Jumbotron -->
          ...
          <?php foreach ($formCetak as $cetak) : ?>
            <tr>
              ...
              <td class="text-center">
                ...
                <!-- Tombol Hapus -->
                <a href="hapuselektronik.php?id=<?= $cetak["id"]; ?>" onclick="return confirm('Apakah Data Yang diHapus Sudah Benar?!');">Hapus</a>
                <!-- Tombol Hapus -->
              </td>
